/**
 * Chapter-local helpers for quant.pipes-cisterns (kept inside the chapter folder so the chapter stays self-contained).
 */
...
export function tank(rng: Rng): string {
  return rng.pick([
    'an overhead tank on a farm',
    'a water tank at a school',
    'a cistern at a dairy farm',
    'the village water tank',
    'a storage tank at a rice mill',
    'a tank on the roof of a bank branch',
  ]);
}
